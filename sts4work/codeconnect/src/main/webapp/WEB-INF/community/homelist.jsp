...
<nav class="nav" style="margin-top: 50px;">
	<ul>
		<a class="nav-link" href="${root }/ipgo/list">홈</a>
	    <a class="nav-link" href="${root }/ipgo/interviewlist">현직자 인터뷰</a>
	</ul>
</nav>
    ...
    <div class="section_inner">
        ...
        <ul class="list_story">
            <c:forEach var="dto" items="${list}">
                <li class="item">
                    <a href="#">${dto.com_title}</a>
                    <div class="details">
                        <span class="comment">${dto.com_nickname}</span>
                        <span class="views"><fmt:formatDate value="${dto.com_writetime}" pattern="yyyy-MM-dd"/></span>
                    </div>
                </li>
            </c:forEach>
        </ul>
